...
//  MegaProject
//
//  Created by Tucker, Jonah on 5/1/17.
...
template <class Type>
long HashTable<Tupe> :: findPosition(HashNode<Type> * data)
{
...
template <class Type>
long HashTable<Type> :: handlCollision(HashNode<Type> * data, long currentPosiiton)
{
    long shift = 17;
